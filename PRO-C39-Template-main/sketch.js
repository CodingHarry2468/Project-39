/*---------------------------------------*/
//Coded By: Harkirat  Purpose: Project 39
/*---------------------------------------*/
...
function setup() {
  ...
  //making jungle sprite
  jungle = createSprite(400,100,400,20);
  jungle.addImage("jungle",jungleImage);
  jungle.scale=0.3
  jungle.x = width /2;
 //making kangaroo sprite
...
function draw() {
  ...
  //camera position for kangaroo
  kangaroo.x=camera.position.x-270;
   
  //infininte jungle background
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    //making kangaroo colide with invisible ground
...
//spaning the obstacles function
